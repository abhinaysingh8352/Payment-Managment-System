...
public class PaymentUpdateRequest {
    ...
    private PaymentType paymentTypeJava;
    ...
    public PaymentType getPaymentType() { return paymentTypeJava; }
    public void setPaymentType(PaymentType paymentTypeJava) { this.paymentTypeJava = paymentTypeJava; }
